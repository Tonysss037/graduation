  ...
  <header class="header has-background-white has-text-black">
    <b-navbar class="container is-white" :fixed-top="true">
      ...
      <template slot="start">
        ...
        <b-navbar-item @click="returnlast"> 👈 后退 </b-navbar-item>
      </template>
      ...
      <template slot="end">
        <iframe
          ...
          src="https://i.tianqi.com/index.php?c=code&id=34&py=lianyungang&num=3"
        ></iframe>
        ...
        <b-navbar-dropdown v-else :label="user.alias">
          <b-navbar-item
            tag="router-link"
            :to="{ path: `/member/${user.username}/post` }"
          >
            🧘 话题中心
          </b-navbar-item>
          ...
          <b-navbar-item
            tag="router-link"
            :to="{ path: `/member/${user.username}/team` }"
          >
            🏘️ 组队中心
          </b-navbar-item>
          <hr class="dropdown-divider" />
          ...
          <b-navbar-item
            tag="router-link"
            :to="{ path: `/member/${user.username}/club` }"
          >
            🏌️ 活动中心
          </b-navbar-item>
          <hr class="dropdown-divider" />
...
export default {
  ...
  data() {
    return {
      ...
      jouImg: require("@/assets/image/jou_logo.jpg"),
      searchKey: "",
      darkMode: false,
    };
  },
