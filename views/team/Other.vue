        ...
        >
          ...
          <div class="media-content">
            ...
            <nav class="level has-text-grey is-mobile is-size-6 mt-2">
              ...
              <div v-if="item.view <= 99" class="media-right">
                <b-button
...
<script>
import { getListOther, join } from "@/api/team";
...
export default {
  ...
  methods: {
    init(tab) {
      getListOther(this.page.current, this.page.size, tab).then((response) => {
        const { data } = response;
