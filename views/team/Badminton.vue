          ...
          <div class="media-left">
            <figure>
              <img
                ...
                src="../../assets/image/badminton.jpg"
              />
            </figure>
          </div>
              ...
              <div class="level-left">
                <div class="level-left">
                  ...
                  <span class="is-hidden-mobile" style="margin-left: 7px"
                    >组队人数:{{ item.view }}/2人</span
                  >
                </div>
              </div>
              <div v-if="item.view <= 1" class="media-right">
                <b-button
...
<script>
import { getListBadminton, join } from "@/api/team";
...
export default {
  ...
  methods: {
    init(tab) {
      getListBadminton(this.page.current, this.page.size, tab).then(
        (response) => {
          const { data } = response;
