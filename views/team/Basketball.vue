          ...
          <div class="media-left">
            <figure>
              <img
                ...
                src="../../assets/image/basketball.jpg"
              />
            </figure>
          </div>
              ...
              <div class="level-left">
                <div class="level-left">
                  ...
                  <span class="is-hidden-mobile" style="margin-left: 7px"
                    >组队人数:{{ item.view }}/10人</span
                  >
                </div>
              </div>
              <div v-if="item.view <= 9" class="media-right">
                <b-button
...
<script>
import { getListBasketball, join } from "@/api/team";
...
export default {
  ...
  methods: {
    init(tab) {
      getListBasketball(this.page.current, this.page.size, tab).then(
        (response) => {
          const { data } = response;
