package com.graduation.graduation.jwt;
...
//                System.out.println(request.getMethod());
    ...
    private boolean isProtectedUrl(HttpServletRequest request) {
        ...
        protectedPaths.add("/team/create");
        protectedPaths.add("/post/update");
        protectedPaths.add("/team/update");
        protectedPaths.add("/post/delete/*");
        protectedPaths.add("/team/delete/*");
        protectedPaths.add("/club/member/delete/*");
        protectedPaths.add("/team/join/*");
        protectedPaths.add("/club/join/*");
